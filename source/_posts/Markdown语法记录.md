---
title: Markdown语法记录
date: 2019-11-21 01:02:20
tags: [教程,markdown]
categories: [学习, markdown]
mathjax: true
---
	
虽然以前使用github接触过markdown语法，但是由于搭建博客以及后续博文撰写的关系，对markdown语法有了真正运用的场景。  

在这篇文章下逐渐更新对markdown的使用和理解！！！
...
示例
```
我觉得[刘伟康](http://www.lwk4you.com)真是个帅帅的博主😊.
```
